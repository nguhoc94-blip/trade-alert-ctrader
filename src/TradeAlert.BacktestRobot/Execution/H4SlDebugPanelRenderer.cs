...
/// <summary>Draggable on-chart panel for H4 SL mode debug (pool status, p25/mean/p75, active guard band).</summary>
public sealed class H4SlDebugPanelRenderer
{
    readonly List<TextBlock> _lineBlocks = new(24);
    ...
    const double DefaultInitialY = 380;

    readonly double _initialY;

    public H4SlDebugPanelRenderer(double initialY = DefaultInitialY) =>
        _initialY = initialY;
